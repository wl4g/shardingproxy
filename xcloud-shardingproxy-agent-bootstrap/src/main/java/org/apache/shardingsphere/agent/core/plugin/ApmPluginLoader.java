...
public final class ApmPluginLoader extends ClassLoader implements Closeable, PluginLoader {
    ...
    //
    // Add for default value emptyMap()
    //
    private Map<String, PluginInterceptorPoint> interceptorPointMap = emptyMap();
    ...
    public void loadAllPlugins() throws IOException {
        ...
        if (null == jarFiles) {
            // Add for WARNNING not found plug-ins.
    ...
    private void loadPluginDefinitionServices(final Set<String> ignoredPluginNames,
            final Map<String, PluginInterceptorPoint> pointMap) {
        PluginServiceLoader.newServiceInstances(PluginDefinitionService.class).stream()
    ...
    private void buildPluginInterceptorPointMap(final PluginDefinitionService pluginDefinitionService,
            final Map<String, PluginInterceptorPoint> pointMap) {
