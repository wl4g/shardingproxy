...
public final class ProxyContext {
    ...
    //
    // ADD for failover configuration.
    //
    private FailoverConfiguration failoverConfig = new FailoverConfiguration();
     ...
     * @return rules
     */
    // TODO performance enhancement: cache when call init() and pay attention
    // for refresh of rule modification
